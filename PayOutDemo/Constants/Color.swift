...
class Color {
    ...
    // Aplications colors
    public class var MainColor: UIColor { return #colorLiteral(red: 0.3882352941, green: 0.2470588235, blue: 0.6823529412, alpha: 1) }
    public class var White: UIColor { return #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) }
    public class var MainBackground: UIColor { return #colorLiteral(red: 0.9647058824, green: 0.9647058824, blue: 0.9647058824, alpha: 1) }
    public class var MainTableViewBackground: UIColor { return #colorLiteral(red: 0.937254902, green: 0.937254902, blue: 0.9568627451, alpha: 1) }
    public class var LighGrey: UIColor { return #colorLiteral(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1) }
    public class var MainGrey: UIColor { return #colorLiteral(red: 0.5951961279, green: 0.6001907587, blue: 0.6000030637, alpha: 1) }
    public class var DarkGrey: UIColor { return #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1) }
    public class var Grey: UIColor { return #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1) }
    public class var IncomingGreen: UIColor { return #colorLiteral(red: 0.2745098174, green: 0.4862745106, blue: 0.1411764771, alpha: 1) }
    public class var IncomingLightGreen: UIColor { return #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1) }
    public class var OutcomingRed: UIColor { return #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1) }
    public class var OutcomingLightRed: UIColor { return #colorLiteral(red: 1, green: 0.368627451, blue: 0.2078431373, alpha: 1) }
